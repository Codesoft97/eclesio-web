  ...
  return (
    <div className="w-full max-w-xl animate-slide-up py-8">
      ...
      <p className="mt-6 text-sm text-muted">
        Já tem uma conta?{" "}
        <Link href="/login" className="font-semibold text-foreground underline decoration-accent decoration-2 underline-offset-4 transition-colors hover:text-accent">
          Entrar
        </Link>
      </p>
    </div>
