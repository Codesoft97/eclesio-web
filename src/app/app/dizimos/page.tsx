export default function DizimosPage() {
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <h1 className="mt-2 text-3xl font-semibold text-foreground">Dizimos</h1>
      <div className="mt-6 border border-border bg-surface p-6 text-sm leading-6 text-muted shadow-sm">
        Esta tela esta reservada para o modulo de Dizimos. A sidebar ja esta preparada para navegacao interna.
      </div>
    </div>
  );
}